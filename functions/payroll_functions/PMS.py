...
# ! di na kailangan, from Flutter yung data
payroll = Tk()
...
lblEmployeeName = Label(LeftInsideLF,
                        font=('arial', 12, 'bold'),
                        text="Employee Name",
                        fg="Steel Blue",
                        bd=10,
...
txtEmployeeName = Entry(LeftInsideLF,
                        font=('arial', 12, 'bold'),
                        bg="powder blue",
                        bd=1,
                        width=54,
...
lblRefrence = Label(LeftInsideLF,
                    font=('arial', 12, 'bold'),
                    text="Reference",
                    fg="Steel Blue",
                    bd=10,
...
txtRefrence = Entry(LeftInsideLF,
                    font=('arial', 12, 'bold'),
                    bg="powder blue",
                    bd=1,
                    width=54,
...
lblEmployerName = Label(LeftInsideLF,
                        font=('arial', 12, 'bold'),
                        text="Employer Name",
                        fg="Steel Blue",
                        bd=10,
...
txtEmployerName = Entry(LeftInsideLF,
                        font=('arial', 12, 'bold'),
                        bg="powder blue",
                        bd=1,
                        width=54,
...
lblJobStatus = Label(LeftInsideLF,
                     font=('arial', 12, 'bold'),
                     text="Job Status",
                     fg="Steel Blue",
                     bd=10,
...
txtJobStatus = Entry(LeftInsideLF,
                     font=('arial', 12, 'bold'),
                     bg="powder blue",
                     bd=1,
                     width=54,
                     justify='left',
                     textvariable=JobStatus)
txtJobStatus.grid(row=5, column=1)

lblCity = Label(LeftInsideLFLF,
                font=('arial', 12, 'bold'),
                text="City Weighting",
                fg="Steel Blue",
                bd=10,
...
lblBasicSalary = Label(LeftInsideLFLF,
                       font=('arial', 12, 'bold'),
                       text="Basic Salary",
                       fg="Steel Blue",
                       bd=10,
...
txtBasicSalary = Entry(LeftInsideLFLF,
                       font=('arial', 12, 'bold'),
                       bg="powder blue",
                       bd=1,
                       width=18,
...
lblOverTime = Label(LeftInsideLFLF,
                    font=('arial', 12, 'bold'),
                    text="Over Time",
                    fg="Steel Blue",
                    bd=10,
...
txtOverTime = Entry(LeftInsideLFLF,
                    font=('arial', 12, 'bold'),
                    bg="powder blue",
                    bd=1,
                    width=18,
...
lblGrossPay = Label(LeftInsideLFLF,
                    font=('arial', 12, 'bold'),
                    text="GrossPay",
                    fg="Steel Blue",
                    bd=10,
...
txtGrossPay = Entry(LeftInsideLFLF,
                    font=('arial', 12, 'bold'),
                    bg="powder blue",
                    bd=1,
                    width=18,
...
lblNetPay = Label(LeftInsideLFLF,
                  font=('arial', 12, 'bold'),
                  text="Net Pay",
                  fg="Steel Blue",
                  bd=10,
...
txtNetPay = Entry(LeftInsideLFLF,
                  font=('arial', 12, 'bold'),
                  bg="powder blue",
                  bd=1,
                  width=18,
...
lblPension = Label(LeftInsideRFRF,
                   font=('arial', 12, 'bold'),
                   text="Pension",
                   fg="Steel Blue",
                   bd=10,
...
txtPension = Entry(LeftInsideRFRF,
                   font=('arial', 12, 'bold'),
                   bg="powder blue",
                   bd=1,
                   width=18,
...
lblStudentLoan = Label(LeftInsideRFRF,
                       font=('arial', 12, 'bold'),
                       text="Student Loan",
                       fg="Steel Blue",
                       bd=10,
...
txtStudentLoan = Entry(LeftInsideRFRF,
                       font=('arial', 12, 'bold'),
                       bg="powder blue",
                       bd=1,
                       width=18,
...
lblNIPayment = Label(LeftInsideRFRF,
                     font=('arial', 12, 'bold'),
                     text="NI Payment",
                     fg="Steel Blue",
                     bd=10,
...
txtNIPayment = Entry(LeftInsideRFRF,
                     font=('arial', 12, 'bold'),
                     bg="powder blue",
                     bd=1,
                     width=18,
...
lblDeductions = Label(LeftInsideRFRF,
                      font=('arial', 12, 'bold'),
                      text="Deductions",
                      fg="Steel Blue",
                      bd=10,
...
txtDeductions = Entry(LeftInsideRFRF,
                      font=('arial', 12, 'bold'),
                      bg="powder blue",
                      bd=1,
                      width=18,
...
lblPostCode = Label(RightInsideLF,
                    font=('arial', 12, 'bold'),
                    text="Post Code",
                    fg="Steel Blue",
                    bd=10,
...
txtPostCode = Entry(RightInsideLF,
                    font=('arial', 12, 'bold'),
                    bg="powder blue",
                    bd=1,
                    width=54,
...
lblDepartment = Label(RightInsideLF,
                      font=('arial', 12, 'bold'),
                      text="Department",
                      fg="Steel Blue",
                      bd=10,
...
txtDepartment = Entry(RightInsideLF,
                      font=('arial', 12, 'bold'),
                      bg="powder blue",
                      bd=1,
                      width=54,
...
lblPayDate = Label(RightInsideLFLF,
                   font=('arial', 12, 'bold'),
                   text="Pay Date - d/m/y",
                   fg="Steel Blue",
                   bd=10,
...
txtPayDate = Entry(RightInsideLFLF,
                   font=('arial', 12, 'bold'),
                   bg="powder blue",
                   bd=1,
                   width=18,
...
lblTaxPeriod = Label(RightInsideLFLF,
                     font=('arial', 12, 'bold'),
                     text="Tax Period",
                     fg="Steel Blue",
                     bd=10,
...
txtTaxPeriod = Entry(RightInsideLFLF,
                     font=('arial', 12, 'bold'),
                     bg="powder blue",
                     bd=1,
                     width=18,
...
lblNINumber = Label(RightInsideLFLF,
                    font=('arial', 12, 'bold'),
                    text="NI Number",
                    fg="Steel Blue",
                    bd=10,
...
txtNINumber = Entry(RightInsideLFLF,
                    font=('arial', 12, 'bold'),
                    bg="powder blue",
                    bd=1,
                    width=18,
...
lblNICode = Label(RightInsideLFLF,
                  font=('arial', 12, 'bold'),
                  text="NI Code",
                  fg="Steel Blue",
                  bd=10,
...
txtNICode = Entry(RightInsideLFLF,
                  font=('arial', 12, 'bold'),
                  bg="powder blue",
                  bd=1,
                  width=18,
...
lblTaxablePay = Label(RightInsideLFLF,
                      font=('arial', 12, 'bold'),
                      text="Taxable Pay",
                      fg="Steel Blue",
                      bd=10,
...
txtTaxablePay = Entry(RightInsideLFLF,
                      font=('arial', 12, 'bold'),
                      bg="powder blue",
                      bd=1,
                      width=18,
...
lblPensionPay = Label(RightInsideLFLF,
                      font=('arial', 12, 'bold'),
                      text="Pension Pay",
                      fg="Steel Blue",
                      bd=10,
...
txtPensionPay = Entry(RightInsideLFLF,
                      font=('arial', 12, 'bold'),
                      bg="powder blue",
                      bd=1,
                      width=18,
                      justify='left',
                      textvariable=PensionPay)
txtPensionPay.grid(row=5, column=1)

lblOtherPaymentDue = Label(RightInsideLFLF,
                           font=('arial', 12, 'bold'),
                           text="Other Payment Due",
                           fg="Steel Blue",
                           bd=10,
                           anchor='w')
lblOtherPaymentDue.grid(row=6, column=0)
txtOtherPaymentDue = Entry(RightInsideLFLF,
                           font=('arial', 12, 'bold'),
                           bg="powder blue",
                           bd=1,
                           width=18,
...
btnWagePayment = Button(RightInsideRFRF,
                        padx=8,
                        bd=8,
                        fg="black",
                        font=('arial', 16, 'bold'),
                        ...
                        text="Wage Payment",
                        bg="powder blue",
                        command=MonthlySalary).grid(row=1, column=0)
btnReset = Button(RightInsideRFRF,
                  padx=8,
                  bd=8,
                  fg="black",
                  font=('arial', 16, 'bold'),
...
btnPayRef = Button(RightInsideRFRF,
                   padx=8,
                   bd=8,
                   fg="black",
                   font=('arial', 16, 'bold'),
                   ...
                   text="Pay Reference",
                   bg="powder blue",
                   command=PayRef).grid(row=3, column=0)
btnPayCode = Button(RightInsideRFRF,
                    padx=8,
                    bd=8,
                    fg="black",
                    font=('arial', 16, 'bold'),
                    ...
                    text="Pay Code",
                    bg="powder blue",
                    command=PayPeriod).grid(row=4, column=0)
btnExit = Button(RightInsideRFRF,
                 padx=8,
                 bd=8,
                 fg="black",
                 font=('arial', 16, 'bold'),
                 ...
                 text="Exit",
                 bg="powder blue",
                 command=Exit).grid(row=5, column=0)
